...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/28 01:47:55 by hcummera          #+#    #+#             */
/*   Updated: 2019/10/28 01:47:57 by hcummera         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../ft_printf.h"

static int	ft_type_xup_l_ll_check(t_param param, va_list ap, t_buf *buf)
{
	if (param.length == 0)
		ft_print_x_up(param,
...
static int	ft_type_xup_h_hh_check(t_param param, va_list ap, t_buf *buf)
{
	if (param.length == 'h')
		ft_print_x_up(param,
...
static int	ft_type_xup_j_z_check(t_param param, va_list ap, t_buf *buf)
{
	if (param.length == 'j')
		ft_print_x_up(param,
...
{
	if (!(ft_type_xup_l_ll_check(param, ap, buf)))
		if (!(ft_type_xup_h_hh_check(param, ap, buf)))
			ft_type_xup_j_z_check(param, ap, buf);
}
